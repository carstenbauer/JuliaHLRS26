...
function main()
    ...
    # naive
    @test matmul_naive!(C, A, B) ≈ C_result
    ...
    # contiguous
    # @test matmul_contiguous!(C, A, B) ≈ C_result # this should give true, otherwise your implementation is incorrect.
    ...
    # cache blocking
    # @test matmul_cache_blocking!(C, A, B) ≈ C_result
